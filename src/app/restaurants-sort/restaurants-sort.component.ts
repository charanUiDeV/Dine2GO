...
export class RestaurantsSortComponent implements OnInit {
  ...
  ngOnInit() {
    this.records= [
      ...
      { Name: "Saalna",  locationName: "plano 75025",Zipcode:"75025" ,img:"https://cdn.restaurantguru.com/restaurants/small/w312/h280/166629226.jpg" },
      ...
      { Name: "Biriyani Pot @hilltop",  locationName: "Irving 75038",Zipcode:"75038", img:"https://s3-media4.fl.yelpcdn.com/bphoto/fInpZ0m_O0RkIQTB56EvrA/ls.jpg" },
